...
<meta http-equiv="refresh" content="0; <%=request.getContextPath()%>/intern/startseite.jsp">
<meta charset="UTF-8">
	...
	<div class="container" id="maincontainer"
		...
		<div class="row" style="margin-top: 8px;">
			...
			<div class="col-md-10" style="padding-left: 10px;">
				<div id="content">
					Sie werden automatisch weitergeleitet. Sollte die Weiterleitung versagen, klicken Sie bitte hier: <a href="<%=request.getContextPath()%>/intern/startseite.jsp">Startseite</a>
				</div>
